...
FLIGHT_ALT = 1
fps = 1 # how many inferences the program will make per second
max_d = 0.1 # maximum distance the drone will move with any 1 inference (meters)
...
distance_threshold = .5 # maximum distance drone will idle
...
if __name__ == '__main__':
    ...
    while 1:
        ...
        if abs(distance_t) > distance_threshold:
